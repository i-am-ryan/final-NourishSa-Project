...
CREATE INDEX IF NOT EXISTS idx_donations_location ON donations USING GIST (ll_to_earth(latitude, longitude));
...
CREATE INDEX IF NOT EXISTS idx_food_hubs_location ON food_hubs USING GIST (ll_to_earth(latitude, longitude));
CREATE INDEX IF NOT EXISTS idx_user_profiles_location ON user_profiles USING GIST (ll_to_earth(latitude, longitude)) WHERE latitude IS NOT NULL;
