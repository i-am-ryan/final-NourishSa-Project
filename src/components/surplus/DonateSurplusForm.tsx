// src/components/surplus/DonateSurplusForm.tsx
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        >
          ...
          <Select
            ...
            onValueChange={(value) =>
              setFormData({ ...formData, donorType: value, businessName: '' })
            }
          >
        ...
        <AnimatePresence>
          {formData.foodType &&
            (formData.foodType !== 'Other' || formData.customFoodType) && (
              <motion.div
                initial={{ opacity: 0, height: 0 }}
                animate={{ opacity: 1, height: 'auto' }}
                exit={{ opacity: 0, height: 0 }}
        ...
        <AnimatePresence>
          {formData.expiryDate && (
            ...
            >
              ...
              <div className="relative border-2 border-dashed border-gray-300 rounded-2xl p-8 text-center hover:border-green-400 transition-colors bg-gradient-to-br from-gray-50 to-white">
                <input
                  type="file"
                  accept="image/*"
                  onChange={(e) =>
        ...
        <AnimatePresence>
          {formData.expiryDate && (
            ...
            >
              ...
              >
                {loading ? 'Submitting…' : 'Donate Surplus'}
              </Button>
            </motion.div>
          )}
        </AnimatePresence>
